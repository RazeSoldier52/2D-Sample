This is a 2D Platformer prototype I made as my first game to start my journey to game development and learning Unity.
...
Engine:Unity 6
Language:C#
Art Style: Pixel Art (Using Free Assets From Unity Store)

How To Play
1.Clone the Repo: `git clone https://github.com/RazeSoldier52/2D-Sample.git`
